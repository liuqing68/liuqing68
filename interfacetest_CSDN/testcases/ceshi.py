import json
import unittest
from common.HttpEngine import HttpEngine
...
geturl=geturlParams() # 调用我们的geturlParams获取我们拼接的URL
url = geturl.get_Url()
...
class testUserLogin(unittest.TestCase):
    ...
    def checkResult(self):  # 断言
        ...
        info = HttpEngine().run_main(self.method, url, data1)  # 根据Excel中的method调用run_main来进行requests请求，并拿到响应
